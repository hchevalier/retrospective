    ...
    <div id={task.id} className='bg-gray-100 rounded shadow'>
      ...
      {!readOnly && <div className='px-6 pb-4'>
        <span className='inline-block bg-gray-200 rounded-full px-3 py-1 mr-2'>
          <svg className='edit-icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='20' height='20' onClick={() => onEdit(task)}>
        ...
        <span className='inline-block bg-gray-200 rounded-full px-3 py-1'>
          <svg className='delete-icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='20' height='20' onClick={() => onDelete(task)}>
